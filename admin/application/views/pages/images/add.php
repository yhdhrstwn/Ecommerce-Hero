...
<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo site_url('Images/simpan')?>" method="post" enctype="multipart/form-data">
            <div class="card-body">

              <div class="form-group">
                <label for="exampleInputEmail1">Nama Gambar</label>
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama" name="Nama" value="<?php echo set_value('Nama');?>">
              </div>
